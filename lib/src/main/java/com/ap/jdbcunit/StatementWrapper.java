...
public class StatementWrapper implements Statement {
  ...
  public boolean execute(String sql) throws SQLException {
    if (JDBCUnit.isRecording()) {
      System.out.println("JDBCUnit WARN: execute(String sql) is not recorded (StatementWrapper)");
    }
  ...
  public ResultSet getResultSet() throws SQLException {
    if (JDBCUnit.isRecording()) {
      System.out.println("JDBCUnit WARN: getResultSet() is not recorded (StatementWrapper)");
    }
  ...
  public int[] executeBatch() throws SQLException {
    if (JDBCUnit.isRecording()) {
      System.out.println("JDBCUnit WARN: executeBatch() is not recorded (StatementWrapper)");
    }
